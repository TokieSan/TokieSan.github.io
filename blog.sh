...
<link href=\"https://tokiesan.github.io/blogposts/${url_alias}.html\"/>
<updated>"${xmlDate}"</updated>
<id>https://tokiesan.github.io/blogposts/${url_alias}.html</id>
</entry>
</feed>" >> atom.xml
...
awk -v FOO1="${newElem}" '{
    sub(/<!---->/, "<!----> " FOO1);
    print;
}' blogposts/index.html > temporary_output
cat temporary_output > blogposts/index.html
rm -rf temporary_output 

mv ${file_name} junk/

# Add new post to repo
git add "blogposts/${url_alias}.html" "atom.xml" "blogposts/index.html"
